<template>
  <div>
    <el-row :gutter="20" class="titleBox">
      ...
      <el-col :xs="24" :sm="8" align="right">
        <el-button-group v-if="!$router.history.current.query.from">
          ...
          <el-button size="small" icon="el-icon-printer" @click="Printing" v-has="1020">打印</el-button>
        </el-button-group>
      </el-col>
    </el-row>
    <el-row :gutter="20">
    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="24" :sm="3" v-if="form.rCuidv && form.rStatus!=19">
        <el-button
          size="mini"
          type="warning"
          icon="el-icon-plus"
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24">
        ...
        >
          ...
          <el-table-column sortable align="center" property="sumPrice" label="总金额">
    ...
    <el-row :gutter="20" :class="footstyle" class="mbottom">
      <el-col :xs="24" :sm="24">
...
export default {
  ...
  watch: {
    $route(to, from) {
      let keepAlive = sessionStorage.getItem("salesKeepAlive") || "";
  ...
  methods: {
    ...
    btnSubmit(val) {
      ...
      if (!this.form.rCidv) {
        this.$message({ message: "请选择收货人", type: "warning" });
        return false;
      }
      if (!this.form.rWhidv) {
      ...
      //   return false;
      // }
      // if (this.TotalPrice1+this.TotalPrice==0) {
      //   this.$message({
      //     message: "当前订单为0，请选择商品或服务项",
      //     type: "warning"
      //   });
      //   return false;
      // }
    ...
    iptBlur(val) {
      ...
      if (!isNaN(val.iSellingprice)) {
        if (!val.iSellingprice) {
          ...
          this.$message.warning("当前销售价小于最低销售价");
        }
      } else {
        val.iSellingprice = 1;
        this.$message.warning("请输入数字");
    ...
    setdanjia(e) {
      if (!isNaN(e.iSellingprice)) {
        ...
        } else if (Number(e.iSellingprice) < 0) {
          e.iSellingprice = 0;
