        ...
        <div class="grid-content bg-purple-light">
          <div class="tableBox d-shadow">
            ...
            >
              ...
              <el-table-column sortable align="center" prop="bankAccountId" label="账户ID"></el-table-column>
              <el-table-column
                sortable
                align="center"
...
export default {
  ...
  methods: {
    getList(val) {
      ...
      this.$api.ReportCapital.capitalBalanceDetails(d).then(res => {
    ...
    exportTable() {
      ...
      try {
        this.$fileSaver.saveAs(
          ...
          `资金余额汇总列表${getDate.getToday().starttime}.xlsx`
        );
      } catch (e) {
        // 错误处理方式
      }
