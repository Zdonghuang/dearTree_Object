        ...
        <div class="grid-content bg-purple-light">
          <div class="tableBox d-shadow">
            ...
            >
              ...
              <el-table-column sortable align="center" show-overflow-tooltip property="raccountdate" label="记账日期"></el-table-column>
              ...
              <el-table-column sortable align="center" show-overflow-tooltip property="rcuid" label="客户ID"></el-table-column>
              ...
              <el-table-column sortable align="center" show-overflow-tooltip property="rdtotalsellingprice" label="金额" width="120">
                <template slot-scope="scope">
                  <div class="tr">
              ...
              <el-table-column sortable align="center" show-overflow-tooltip property="gpurorrecoverv" label="商品来源/采购回收商品"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList(val) {
      ...
      this.$api.Stat.statxsljsdmxNew(params).then(res => {
        loading.close();
        if (res.code == 200) {
    ...
    exportTable() {
      ...
      try {
        this.$fileSaver.saveAs(
          ...
          `销售类结算单明细${getDate.getToday().starttime}.xlsx`
        );
      } catch (e) {
        // 错误处理方式
      }
