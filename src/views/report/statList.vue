...
<template>
  <div>
    ...
    >
      ...
      <el-table-column sortable align="center" property="rname" label="单据类型"></el-table-column>
...
export default {
  ...
  methods: {
    getList() {
      ...
      if (!params.rCuserid) delete params.rCuserid;
    ...
    setdate(e) {
      if (e.target.nodeName === "LI") {
        ...
        let params = {
          sDate: this.form.sDate.replace(new RegExp("-", "g"), ""),
          eDate: this.form.eDate.replace(new RegExp("-", "g"), "")
        };
        this.getList();
      }
    },
