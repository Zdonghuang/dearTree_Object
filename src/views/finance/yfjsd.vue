<template>
  <div>
    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="24" :sm="4">
        <el-input placeholder="预付余额" v-model="pFamount" size="small" readonly disabled>
  ...
  methods: {
    ...
    setmoney(v) {
      ...
      if (v.PAmount > this.pFamount) {
        v.PAmount = 0;
        return this.$message.error("不能超出客户预付余额");
      }
    },
    searchbox(e, val) {
      this.rowindex = val;
