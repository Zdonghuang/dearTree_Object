<template>
  <div>
    ...
    >
      ...
      <el-table-column sortable align="center" property="PD_BANKNAMEGH" label="账户" show-overflow-tooltip></el-table-column>
    ...
    exportTable() {
      ...
      try {
        this.$fileSaver.saveAs(
          ...
          `预付减少列表${getDate.getToday().starttime}.xlsx`
        );
      } catch (e) {
        // 错误处理方式
      }
