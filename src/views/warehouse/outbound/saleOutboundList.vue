<template>
  <div>
    ...
    <el-row :gutter="20">
      ...
      <el-col :sm="4" :xs="24">
        <el-input placeholder="来源订单" v-model="form.rItemnumparent" size="small" clearable>
  ...
  methods: {
    ...
    toOrderPage(val, e) {
      if (e) {
        ...
        this.$router.push({
          path: "/warehouse/outbound/XSoutboundDetail",
    ...
    exportTable() {
      ...
      try {
        this.$fileSaver.saveAs(
          ...
          `销售送货单列表${getDate.getToday().starttime}.xlsx`
        );
      } catch (e) {
        // 错误处理方式
      }
