<template>
  <div>
    ...
    >
      ...
      <el-table-column sortable align="center" show-overflow-tooltip property="rTotalprice" label="总租金">
        <template slot-scope="scope">
      ...
      if (e) {
        if (e == "YD") {
          this.$router.push({
            ...
            query: { data: window.btoa(val.rItemnumparent) }
          });
        }
      } else {
        this.$router.push({
          path: "/lease/leaseXZOrder",
    ...
    exportTable() {
      ...
      try {
        this.$fileSaver.saveAs(
          ...
          `租赁续租列表${getDate.getToday().starttime}.xlsx`
        );
      } catch (e) {
        // 错误处理方式
      }
