<template>
  <div>
    ...
    >
      ...
      <el-table-column sortable align="center" property="PD_AMOUNTTOTAL" label="总金额" show-overflow-tooltip>
        <template slot-scope="scope">
    ...
    exportTable() {
      ...
      try {
        this.$fileSaver.saveAs(
          ...
          `核销列表${getDate.getToday().starttime}.xlsx`
        );
      } catch (e) {
        // 错误处理方式
      }
