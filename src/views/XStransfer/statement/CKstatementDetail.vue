<template>
  <div ref="quotationsheet">
    ...
    <el-row :gutter="20" class="mtop15">
      <el-col :xs="24" :sm="6" v-if="form.rStatus==32">
        <el-input v-model="receiptFinancial[0].fsBankname" size="small" readonly>
    ...
    <my-footer
      ...
      BtnText="收款结算"
      :hideBtn1="false"
      :hideBtn2="form.rBillingstatus!=1"
      v-if="form.rStatus!=32"
    ></my-footer>
    <my-footer
      :number="number"
      :Totalamount="form.rTotalprice"
...
export default {
  ...
  created() {
    if (this.$route.query.data) {
      ...
      this.$router.push("/XStransfer/statement/CKstatementList");
    }
  },
  methods: {
    getOrder() {
    ...
    close(data, val1) {
      ...
      if (!params.receiptFinancial[0].fsAmount) params.receiptFinancial = [];
