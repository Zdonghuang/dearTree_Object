          ...
          >
            <el-table-column  property="date" label="操作" align="center" width="80">
              <template>
                ...
                <i class="el-icon-circle-close del" @click="deldate()"></i>
              </template>
            </el-table-column>
            <el-table-column sortable property="cName" label="姓名" align="center">
            ...
            <el-table-column sortable property="cMobile" align="center" label="手机">
              <template slot-scope="scope">
            ...
            <el-table-column sortable property="cAddr" align="center" label="地址">
              <template slot-scope="scope">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        cuDistrict: [{ required: true, message: " ", trigger: "change" }],
        cuHandmanvalue: [{ required: true, message: " ", trigger: "blur" }],
        cuBankcardnum: [{ required: true, message: " ", trigger: "blur" }],
        cuBankname: [{ required: true, message: " ", trigger: "blur" }]
      },
      options: [],
      cascaderAddr: "",
      value: [],
